...
public class TesteAgenda {
  public static void main(String[] args) {
    ...
    agenda.setHomeworkCompleted("Exame final", "POO", 9);
    agenda.setHomeworkCompleted("Atividade avaliativa", "POO", 9);
    agenda.setHomeworkCompleted("Atividade avaliativa", "MB101", 9);

    agenda.printSumHomeworksBySubject("POO");

    agenda.printScoreAverage(24, 3);
  }
}
